...
fn gen_chain(
    ...
    let init_ident = format_ident!("__ConjectInit_{}", name_prefix);
    let init_var = format_ident!("__conject_init_{}", name_prefix);
    ...
    for i in 0..modules.len() - 1 {
        let step_ident = format_ident!("__ConjectInitStep_{}_{}", name_prefix, i);
        ...
        let var_ident = format_ident!("__conject_{}_s{}", name_prefix, i);
