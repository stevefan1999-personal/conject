...
<div align="center">
  ...
  <a href="https://crates.io/crates/conject">
    <img src="https://img.shields.io/crates/v/conject.svg"
    alt="Crates.io version" />
  </a>
  <!-- Downloads -->
  <a href="https://crates.io/crates/conject">
    <img src="https://img.shields.io/crates/d/conject.svg"
      alt="Download" />
  </a>
  <!-- docs -->
...
1. Requires `cargo` to build. Run `cargo clean -p conject-macro` to clean the cache if it ever gets corrupted.
1. Generic parameters are not supported on modules.
